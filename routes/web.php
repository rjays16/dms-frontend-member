...
//     return redirect('/admin/members/applicant');
// });
// Route::get('/admin/members/applicant', [PCRMemberController::class, 'getAllPending']);
// Route::put('/admin/members/applicant/{id}/approve', [PCRMemberController::class, 'approveMember']);
// Route::get('/admin/members/for-processing', [PCRMemberController::class, 'getAllForProcessing']);
...
Route::get('/admin/sessions-start', function () {
    return view('admin.dashboard');
});

Route::get('/admin/sessions/add', function () {
    return view('admin.dashboard');
});

Route::get('/admin/sessions/update', function () {
    return view('admin.dashboard');
});

Route::get('/admin/sessions/participants', function () {
    return view('admin.dashboard');
});
...
Route::get('/admin/rooms/update', function () {
    return view('admin.dashboard');
});
...
Route::get('/admin/tags/users', function () {
    return view('admin.dashboard');
});
...
Route::get('/admin/tags/update', function () {
    return view('admin.dashboard');
});
...
Route::get('/admin/banner/home', function () {
    return view('admin.dashboard');
});

Route::get('/admin/banner/login', function () {
    return view('admin.dashboard');
});
...
Route::get('/admin/collection-fees/list', function () {
    return view('admin.dashboard');
});

Route::get('/admin/fiscal-period/active', function () {
    return view('admin.dashboard');
});

Route::get('/admin/collection-fees/list-fiscal', function () {
    return view('admin.dashboard');
});

Route::get('/admin/collection-fees/list-other', function () {
    return view('admin.dashboard');
});

Route::get('/admin/payment-ledgers/list', function () {
    return view('admin.dashboard');
});
