    ...
    <div class="container">
        <div class="verify-wrapper text-center">
            ...
            <div class="verify-content text-center mb-3" style="font-family: Open Sans; color: #575757; line-height: 1.75;">
                ...
                “This is to confirm receipt of your registration to the 2021 PCR ANNUAL CONVENTION PORTAL/ PCR ONLINE MEMBERSHIP PORTAL. <br/>
                Please allow 3-5 working days for approval of your registration. Please visit your Inbox and Spam folders” <br/><br/>

                Your application details are as follows:<br/><br/>
                <b>Name: </b>{{$registration['first_name']}} {{$registration['middle_name']}} {{$registration['last_name']}} <br/>
                <b>Contact No: </b>{{$registration['contact_number']}} <br/>
                <b>Email: </b>{{$registration['email']}} <br/>
                <b>PRC Number: </b>{{$registration['prc_number']}} <br/>
                <b>Address: </b>{{$registration['address']}} <br/><br/>
                
                We will be sending you another email soon as we verify your information. <br/><br/>
