<template>
    <div>
            ...
            <div class="admin-page-title bg-white p-3">
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6 text-right">
                        <el-button class="mt-2" size="small" type="primary" @click="exportActive()" :disabled="is_exporting" :loading="is_exporting">Export</el-button>
                    </div>
                </div>                
            </div>              
            <div class="container-fluid pb-5">
                <div class="admin-conent bg-white my-5 mx-3 p-4">
                    <h1>Active Members <span class="member-count"  v-if="totalMembers">{{ totalMembers }}</span></h1>                   
                    <div class="row mb-4">
                    ...
                    <div class="table-responsive">
                        ...
                        <div class="block text-center mt-5" v-if="!showSearchRes && members.total !== 0">
                            <ul id="member-pages" class="pcr-pagination">
                                <li class="mx-1">
                                    <el-button class="px-1" @click="getPagedActiveMembers(members.first_page_url)" size="mini" plain type="primary">
                                        First
                                    </el-button>                                    
                                </li>
                                <li class="mx-1" v-for="page in members.links" :key="page.label">
                                    <el-button class="px-2" @click="getPagedActiveMembers(page.url)" size="mini" :plain="page.active ? false : true" type="primary">
                                        {{ paginLabel(page.label) }}
                                    </el-button>
                                </li>
                                <li class="mx-1">
                                    <el-button class="px-1" @click="getPagedActiveMembers(members.last_page_url)" size="mini" plain type="primary">
                                        Last
                                    </el-button>                                    
                                </li>                                
                            </ul>
        ...
        <el-dialog class="member-review-dialog" title="View Member Details" :visible.sync="dialogReviewTab" :before-close="closeReviewTab">
...
export default {
    ...
    methods: {
        ...
        getSearchResults() {
            ...
            axios.get(this.apiDomain + '/api/admin/members/active', {
				params: {
                    is_search: true,
        ...
        exportActive() {
            ...
            axios.get(this.apiDomain + '/api/admin/members/export/active', { 
			...
			.then(res => {
                ...
                link.href = url
                link.setAttribute('download', "active_members.xlsx")
