<template>
    <div>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        <div class="mt-2">
                            ...
                            <span> / Members / Inactive</span>
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-6 text-right">
                        <!--<el-button size="small" type="success" @click="goToImport()">Import</el-button>-->
                        <el-button class="mt-2" size="small" type="primary" @click="exportInactive()" :disabled="is_exporting" :loading="is_exporting">Export</el-button>
                    </div>
                </div>                
            </div>              
            <div class="container-fluid pb-5">
                <div class="admin-conent bg-white my-5 mx-3 p-4">
                    <h1>Inactive Members <span class="member-count" v-if="totalMembers">{{ totalMembers }}</span></h1>
                    <div class="row mb-4">
                    ...
                    <div class="table-responsive">
                        <el-table
                            ...
                            <el-table-column
                                ...
                                label="Memberships">
                                <template slot-scope="scope">
                                    {{ scope.row.membership_type ? scope.row.membership_type.type_name : "None" }}
                                </template>
                            </el-table-column>
                            <!-- <el-table-column
                                prop="updated_at"
                            ...
                            <el-table-column
                                ...
                                <template slot-scope="scope">
                                    ...
                                    <el-button plain class="my-1 mx-0" size="mini" :loading="is_resetting_password" :disabled="is_resetting_password"
                                        @click="resetPassword(scope.row.id)" type="success" icon="el-icon-lock">
                                        Reset Password
                                    </el-button>
                        ...
                        <div class="block text-center mt-5" v-if="!showSearchRes">
                            <ul id="member-pages" class="pcr-pagination">
                                <li class="mx-1">
                                    <el-button class="px-1" @click="getPagedInactiveMembers(members.first_page_url)" size="mini" plain type="primary">
                                        First
                                    </el-button>                                    
                                </li>
                                <li class="mx-1" v-for="page in members.links" :key="page.label">
                                    <el-button class="px-2" @click="getPagedInactiveMembers(page.url)" size="mini" :plain="page.active ? false : true" type="primary">
                                        {{ paginLabel(page.label) }}
                                    </el-button>
                                </li>
                                <li class="mx-1">
                                    <el-button class="px-1" @click="getPagedInactiveMembers(members.last_page_url)" size="mini" plain type="primary">
                                        Last
                                    </el-button>                                    
                                </li>                                
                            </ul>
        ...
        <el-dialog class="member-payment-history" width="85%" title="View Payments" :visible.sync="dialogPaymentHistory">
            <div class="text-right d-none">
                <el-button size="small" type="success" @click="showCollectionFeesDialog = true">
                    Add New
                </el-button>
            </div>    
            <p>{{ paymentHistory.name }}</p>
            <el-table
                ref="memberTable"
                stripe
                ...
                class="member-approved-table"
                style="width: 100%"
                v-loading="isPaymentHistoryLoading">
                <el-table-column
                    prop="order_id"
                    label="Order"> 
                    <template slot-scope="scope">
                ...
                <el-table-column
                    ...
                    <template slot-scope="scope">
                        ...
                        <el-button size="small" v-if="scope.row.order.status != 2" class="w-100 m-0 mb-2" @click="showMarkPaid(scope.row)" type="primary">Mark as Paid</el-button>
        ...
        <el-dialog
            ...
            <el-button size="small" class="mt-3 w-50 m-0"  @click="saveNewBalance()" type="primary">Save</el-button>
        </el-dialog>
...
export default {
    ...
    methods: {
        ...
        getSearchResults() {
            ...
            axios.get(this.apiDomain + '/api/admin/members/inactive', {
				params: {
                    is_search: true,
        ...
        //     axios.get(this.apiDomain + `/api/orders`)
        // },
        paginLabel(label) {
        ...
        exportInactive() {
            ...
            axios.get(this.apiDomain + '/api/admin/members/export/inactive', { 
			...
			.then(res => {
                ...
                link.href = url
                link.setAttribute('download', "inactive_members.xlsx")
        ...
        saveNewBalance() {
            ...
            .then(response => {
                ...
                this.refreshPaymentHistory(this.newBalMemID)
                this.newBalOrderID = ""
                this.newBalMemID = ""
                this.newBalance = 0
