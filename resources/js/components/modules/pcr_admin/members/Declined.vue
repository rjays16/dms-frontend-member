                ...
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        <div class="mt-2">
                            ...
                            <span> / Members / Declined</span>
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-6 text-right d-none">
                        <el-button size="small" type="success" @click="getDeclinedMembers()">Export</el-button>
                    </div>
                </div>                
            </div>              
            <div class="container-fluid pb-5">
                <div class="admin-conent bg-white my-5 mx-3 p-4">
                    <h1>Declined Members <span class="member-count" v-if="totalMembers">{{ totalMembers }}</span></h1>
...
export default {
    ...
    methods: {
        ...
        getSearchResults() {
            ...
            axios.get(this.apiDomain + '/api/admin/members/declined', {
				params: {
                    is_search: true,
