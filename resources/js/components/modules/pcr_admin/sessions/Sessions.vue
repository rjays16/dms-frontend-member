        ...
        <div class="content-wrapper">
            ...
            <div class="container-fluid pb-5">
                <div class="admin-conent bg-white my-5 mx-3 p-4">
                    ...
                    <el-button @click="$router.push('/admin/sessions/add')" type="primary" size="mini" class="float-right sponsors-add-btn ml-3" icon="el-icon-plus">Add Session</el-button>
                        <el-table
                            stripe
                            :data="sessions"
                            class="sessions-table mt-4"
                            ...
                            <!--<el-table-column
                                ...
                                class-name="duration">
                                <template slot-scope="scope">
                                    <div v-if="scope.row.duration_hours === 60">1 Hour</div>
                                    <div v-if="scope.row.duration_hours === 120">2 Hours</div>
                                    <div v-if="scope.row.duration_hours === 180">3 Hours</div>
                                    <div v-if="scope.row.duration_hours === 240">4 Hours</div>
                                    <div v-if="scope.row.duration_hours === 300">5 Hours</div>
                                </template>
                            </el-table-column>-->
                            <el-table-column
                                prop="join_url"
                                ...
                                class-name="join-url">
                                <template slot-scope="scope">
                                    <el-button size="mini" @click="copyJoinURL(scope.row.join_url)" type="default">Copy Link to Clipboard <i class="el-icon-copy-document"></i></el-button>
                                </template>                                
                            </el-table-column>                            
                            <el-table-column
                                prop="actions"
                                ...
                                <template slot-scope="scope">
                                    <!--<el-button class="w-100 my-1 mx-0" size="mini" @click="startMiniSess(scope.row.start_url)" type="success" icon="el-icon-video-play">Start Session as Host</el-button>
                                    <el-button class="w-100 my-1 mx-0" size="mini" @click="joinMiniSess(scope.row.join_url)" type="primary" icon="el-icon-video-play">Join Session</el-button>                                    
                                    <el-button class="my-1 mx-0" size="mini" @click="editMiniSess(scope.row.id)" type="warning" icon="el-icon-edit">Update Session</el-button>
                                    <el-button class="my-1 mx-0" size="mini" @click="showDeleteDialog(scope.row.id)" type="danger" icon="el-icon-delete">Delete Session</el-button>-->
                                    <el-dropdown>
                                    <el-button type="text">
                                        <i class="el-icon-more" style="font-size:18px;color:#131313;"></i>
                                    </el-button>
                                    <el-dropdown-menu slot="dropdown">
                                        <el-dropdown-item>
                                            <el-button class="w-100 " size="mini" @click="startMiniSess(scope.row.start_url)" type="success" icon="el-icon-video-play">Start Session as Host</el-button>
                                        </el-dropdown-item>
                                        <el-dropdown-item>
                                            <el-button class="w-100 " size="mini" @click="joinMiniSess(scope.row.join_url)" type="primary" icon="el-icon-video-play">Join Session</el-button>
                                        </el-dropdown-item>
                                        <el-dropdown-item>
                                            <el-button class="w-100 " size="mini" @click="viewParticipants(scope.row.id)" type="info" icon="el-icon-user">View Participants</el-button>
                                        </el-dropdown-item>
                                        <el-dropdown-item>
                                            <el-button class="w-100 " size="mini" @click="editMiniSess(scope.row.id)" type="warning" icon="el-icon-edit">Update Session</el-button>
                                        </el-dropdown-item>
                                        <el-dropdown-item>
                                            <el-button class="w-100 " size="mini" @click="showDeleteDialog(scope.row.id)" type="danger" icon="el-icon-delete">Delete Session</el-button>
                                        </el-dropdown-item>
                                    </el-dropdown-menu>
                                    </el-dropdown>                                    
                                </template>
...
export default {
    ...
    methods: {
        ...
        copyJoinURL(url) {
            ...
            this.$message.success('Zoom Join Link Copied to Clipboard.')        
        },
        editMiniSess(id) {
            this.$router.push('/admin/sessions/update?id=' + id)
        },
        viewParticipants(id) {
            this.$router.push('/admin/sessions/participants?id=' + id)
        },
        showDeleteDialog(id) {
            this.forDeleteID = id
        ...
        deleteSess() {
            axios.delete(this.apiDomain + `/api/session/delete/${this.forDeleteID}`, {
