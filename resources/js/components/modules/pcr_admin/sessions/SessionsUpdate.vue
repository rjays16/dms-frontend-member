    ...
    <div>
        <div class="content-wrapper">
            <div class="admin-page-title bg-white p-3">
                ...
                <span> / Sessions / Update Session</span>
            </div>
                    ...
                    <div class="bg-white p-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-4">
                                ...
                                <el-input class="mb-4" placeholder="Zoom Email Address" disabled v-model="zoom_email"></el-input>
                            </div>
                            <div class="col-sm-12 col-md-4">
                                <p class="mb-2 font-weight-bold">Zoom Key <span class="required-item">*</span></p>
                                <el-input class="mb-4" placeholder="Zoom Key" disabled v-model="zoom_key"></el-input>
                            </div>
                            <div class="col-sm-12 col-md-4">
                                <p class="mb-2 font-weight-bold">Zoom Secret <span class="required-item">*</span></p>
                                <el-input class="mb-4" placeholder="Zoom Secret" disabled v-model="zoom_secret"></el-input>
                            </div>
                        </div>
                        <!--<div class="col-sm-12 col-md-4">
...
export default {
    ...
    methods: {
        ...
        getSess() {
			...
			.then(res => {
				if(res.data) {
                    ...
                    this.event_name = res.data.data.event_name
                    
                    this.start_date = res.data.data.start_time.slice(0, -9)
                    this.start_time = res.data.data.start_time.slice(11)
                    this.duration = res.data.data.duration_hours
                    this.getRoom(res.data.data.room_id)
        ...
        getAllSponsors() {
            axios.get(this.apiDomain + `/api/sponsors/all`, {
                headers: { Authorization: "Bearer " + this.token }
            })
			.then(res => {
				if(res.data) {
        ...
        saveSesion1() {
            ...
            if (!this.topic) {
                ...
                axios.put(this.apiDomain + `/api/session/update/${this.session_id}`, {
                ...
                .then(response => {
                    ...
                    this.$message.success('Session successfully updated.')
                    this.$router.push('/admin/sessions')
                })
                .catch(error => {
                    if (error.response.data.status_code === 401) {
                        this.$message({
                            message: 'Session could not be updated. Please make sure you have selected a valid Room with correct Zoom Email, Key, and Secret.',
                            type: 'error',
                            duration: 10000
                        })
                    } else {
        ...
        saveSesion2() {
                ...
                axios.put(this.apiDomain + `/api/minisession/room/edit/${this.session_id}`, {
        ...
        getRoom(id) {
            axios.get(this.apiDomain + `/api/room/${id}`, {
                headers: { Authorization: "Bearer " + this.token }
            })
			.then(res => {
				if(res.data) {
