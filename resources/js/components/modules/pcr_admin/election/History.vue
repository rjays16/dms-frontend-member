            ...
            <div class="container-fluid">
                <div class="admin-content bg-white mx-3 p-4">
                    ...
                    <div class="col-sm-12 col-md-6 election-history">
                        ...
                        <div class="mt-3">
                            <select class="el-input__inner" v-model="passedElectionPeriod.data" @change="getElectionPeriodNominees($event.target.value,'select')" style="background: url(/images/layout/arrow_down.png) no-repeat 98% 50%;cursor:pointer">
                ...
                <div class="admin-conent bg-white my-5 mx-3 p-4">
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-12 col-md-12 text-right float-left">
                            <!--<el-button @click="checkPeriod()" type="primary" size="mini" class="nominees-export-btn ml-3">Check Selected Period</el-button>-->
...
export default {
    ...
    methods: {
        ...
        getElectionHistory(type) {
            ...
            axios.get(this.apiDomain + '/api/election/history/'+this.period_id, {
                headers: { Authorization: "Bearer " + this.token }
            })
			.then(res => {
				if(res.data) {
        ...
        exportResult(){
            if (this.passedElectionPeriod.data) {
                window.open(this.apiDomain + '/admin/election/export/' + this.$route.params.id
                                    );
            } else {
                this.$message.error('Please select a past election period first.')
            }
        ...
        checkPeriod() {
            // // console.log(this.passedElectionPeriod.data)
        }
