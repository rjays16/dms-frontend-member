            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body modal-body-padding mt-2">
                        <p class="mb-2 font-weight-bold text-center">Year <span class="required-item">*</span></p>
                        <div v-if="$v.election_year.$dirty">
                            <div class="invalid-field" v-if="!$v.election_year.required">Required</div>
                        </div>  
                         <el-select class="mb-3 year align-width" v-model="election_year" placeholder="Election Year">
                            <el-option
                            v-for="year in years"
                            :key="year"
                            :label="year"
                        ...
                        <div class="date-start-holder">
                            <div class="date-holder float-left">
                            ...
                            <div class="date-holder float-right">
                            ...
                            <div class="time-holder float-left">
                            ...
                            <div class="time-holder float-right">
            ...
            <div class="admin-page-title bg-white p-3">
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6 text-right">
                        <el-button class="mt-2" size="small" type="primary" @click="exportMemberEligibility()" :loading="is_exporting">
                            Export Member Eligibility Status List
                        </el-button>
                    </div>
                </div> 
            </div>
                ...
                <div class="admin-content bg-white mx-3 p-4">
                    ...
                    <div class="col-sm-12 col-md-6 election-history">
                        ...
                        <div class="mt-3">
                            ...
                            <select class="el-input__inner" placeholder="History of Elections" v-model="passedElectionPeriod.data" @change="redirectHistory($event.target.value)" style="background: url(/images/layout/arrow_down.png) no-repeat 98% 50%;cursor:pointer">
...
export default {
    ...
    methods: {
        ...
        getActiveElectionPeriod() {
            axios.get(this.apiDomain + '/api/election/active/admin', {
                headers: { Authorization: "Bearer " + this.token }
            })
			.then(res => {
				if(res.data) {
        ...
        getPassedElectionPeriod() {
            axios.get(this.apiDomain + '/api/election/passed/admin', {
                headers: { Authorization: "Bearer " + this.token }
            })
			.then(res => {
				if(res.data) {
        ...
        getElectionPeriodNominees(id) {
            this.period_id = id;
            axios.get(this.apiDomain + '/api/election/nominees/'+id, {
                headers: { Authorization: "Bearer " + this.token }
            })
			.then(res => {
				if(res.data) {
        ...
        closeElectionPeriod(){
             ...
             //// console.log(id);
                axios.put(this.apiDomain + '/api/election/close/'+id, {
                    is_active: 0},
                    {
                    headers: { Authorization: "Bearer " + this.token }
                })
        ...
        getSearchResults() {
            this.tableLoading = true
             var id = this.period_id;
            axios.get(this.apiDomain + `/api/election/nominated/search?keyword=${this.searchTerm}&id=${id}`, {
                headers: { "Authorization": "Bearer " + this.token }
            })
			.then(res => {
				if(res.data) {
        ...
        createNewElection() {
            ...
            if(!this.$v.$invalid){
                if(this.election_date_started > this.election_date_end){
                    ...
                    axios.post(this.apiDomain + '/api/election/create', {
        ...
        showEditNominee(row) {
            ...
            axios.get(this.apiDomain + '/api/election/nominee/' +row.pcr_member.id, {
                headers: { "Authorization": "Bearer " + this.token }
            }).then(response => {
                if(response.data) {
        ...
        updateNominated(){
            ...
            this.updateConfirmationTab = false
            axios.put(this.apiDomain + '/api/election/updateNominated/'+this.selectedID, {
        ...
        deleteNominee(){
            this.deleteConfirmationTab = false
            axios.delete(this.apiDomain + '/api/election/deleteNominee/'+this.selectedID,{
                 headers: { Authorization: "Bearer " + this.token }
            })
            .then(response => {
        ...
        exportMemberEligibility() {
            this.is_exporting = true
            axios.get(this.apiDomain + '/api/election/exportMemberEligibility', {
                headers: {
			...
			.then(res => {
                ...
                link.href = url
                link.setAttribute('download', "member_eligibility.csv")
