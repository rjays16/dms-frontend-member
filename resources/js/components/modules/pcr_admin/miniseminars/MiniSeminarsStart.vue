                    ...
                    <span class="table-title">Mini-Sessions</span>
                        <el-table
                            ...
                            <el-table-column
                                ...
                                <template slot-scope="scope">
                                    <el-button class="w-100 my-1 mx-0" size="mini" @click="startMiniSess(scope.row.start_url)" type="success" icon="el-icon-video-play">Start Mini-Session as Host</el-button>
                                    <el-button class="w-100 my-1 mx-0" size="mini" @click="joinMiniSess(scope.row.join_url)" type="primary" icon="el-icon-video-play">Join Mini-Session</el-button>
                                </template>
                            </el-table-column>                            
                        </el-table>                   
                </div>
...
export default {
    ...
    computed: {
        showMiniSessions() {
            return this.sessions.filter(data => new Date(data.start_time) > new Date('2021-03-01T00:00:00'))
        } 
    },
    filters: {
