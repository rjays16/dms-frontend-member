    ...
    methods: {
			...
			.then(res => {
				...
				if(res.data.status_code === 200) {
                    if (res.data.data.length > 0) {
                        ...
                        this.footer_file_url = this.apiDomain + '/' + res.data.data[0].footer_logo_img.replace("public", "storage")                        
        ...
        saveFooter() {
            if (!this.footer_file) {
                ...
                axios.post(this.apiDomain + `/api/footer`, footerData,
                    {
                    headers: { Authorization: "Bearer " + this.token }
                })
                .then(response => {
        ...
        editFooter() {
             axios.put(this.apiDomain + `/api/footer/update/${this.footer_id}`, {
            ...
            .then(response => {
                ...
                if (this.footer_file) {
                    ...
                    axios.post(this.apiDomain + `/api/footer/upload`, footerData,
                        {
                        headers: { Authorization: "Bearer " + this.token }
                    })
                    .then(response => {
