    ...
    methods: {
        saveAnn() {
            if (!this.ann_title) {
                ...
                axios.put(this.apiDomain + `/api/pcr/announcement/update/${this.ann_id}`, {
                ...
                .then(response => {
                    ...
                    axios.post(this.apiDomain + `/api/pcr/announcement/updatefile/${this.ann_id}`, annData,
                        {
                        headers: { Authorization: "Bearer " + this.token }
                    })
                    .then(response => {
        ...
        getAnnData() {
            axios.get(this.apiDomain + `/api/pcr/announcement/details/${this.ann_id}`, {
                headers: { Authorization: "Bearer " + this.token }
            })
			.then(res => {
				if(res.data) {
                    ...
                    this.ann_file_url = this.apiDomain + '/' + res.data.file_path.replace("public", "storage")
