    ...
    <div>
        <div class="content-wrapper">
            <div class="admin-page-title bg-white p-3">
                ...
                <span> / Home Page / Related Events / Edit</span>
            </div>            
            <div class="container-fluid pb-5">
                
                <div class="admin-conent my-5 mx-3 p-4">
                    <el-button size="small" class="mb-4" type="primary" @click.native="$router.push('/admin/home/related-events')">Back</el-button>
                    <div class="bg-white p-4">
                        <h1>Edit Related Event Link</h1>      
                        <div class="row">
...
export default {
    data() {
        return {
            ...
            relEvent_id: this.$route.query.id,
            ann_content: '',
            ann_title: '',
            ann_categ: '',
			ann_file: null,
    ...
    methods: {
        ...
        getAnnData() {
            axios.get(`/api/pcr/announcement/details/${this.relEvent_id}`, {
                headers: { Authorization: "Bearer " + this.token }
            })
			.then(res => {
				if(res.data) {
